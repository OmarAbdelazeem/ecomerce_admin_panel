...
class _$MainCategoriesStateTearOff {
  ...
  Loaded loaded(List<MainCategoryModel> categories) {
    return Loaded(
      categories,
    );
  }
...
mixin _$MainCategoriesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MainCategoryModel> categories) loaded,
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<MainCategoryModel> categories)? loaded,
...
class _$Loaded implements Loaded {
  ...
  @override
  String toString() {
    return 'MainCategoriesState.loaded(categories: $categories)';
  }
...
abstract class Loaded implements MainCategoriesState {
  const factory Loaded(List<MainCategoryModel> categories) = _$Loaded;
...
abstract class Error implements MainCategoriesState {
  const factory Error(dynamic error) = _$Error;
